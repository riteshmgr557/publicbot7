...
BOT_OWNER_ROLE="top" # change what you need 
...
async def on_member_join(member):
    ...
    embed.set_footer(text="Developed By ꧁☬⋆ТᎻᎬ༒ᏦᎥᏁᏳ⋆☬꧂#3939 ")
...
async def start(ctx,game:str):
	...
	if BOT_OWNER_ROLE in [role.name for role in author.roles]:
		...
		embed.set_footer(text=f"꧁☬⋆ТᎻᎬ༒ᏦᎥᏁᏳ⋆☬꧂#3939 ", \
            icon_url="https://cdn.discordapp.com/attachments/731757131635621980/735531166886527047/images_11.jpeg")
		embed.timestamp = datetime.datetime.utcnow()
...
async def end(ctx,game:str):
	...
	if BOT_OWNER_ROLE in [role.name for role in author.roles]:
		...
		embed.set_thumbnail(url=url)
		embed.set_image(url="https://cdn.discordapp.com/attachments/539066238870224903/606135147913543693/Tw_1-1-1.gif")
		embed.set_footer(text="꧁☬⋆ТᎻᎬ༒ᏦᎥᏁᏳ⋆☬꧂#3939 ",icon_url="https://cdn.discordapp.com/attachments/731757131635621980/735531166886527047/images_11.jpeg")
		embed.timestamp = datetime.datetime.utcnow()
...
async def invite(ctx):
	await ctx.send("**__@everyone Add Me to Your servers!__**\nhttps://https://discord.com/api/oauth2/authorize?client_id=737000324405002300&permissions=8&scope=bot")
...
bot.run("NzM3MDAwMzI0NDA1MDAyMzAw.Xx2_Cg.yrFkK5QN1-EiGs-S8X6fm98iIkQ")
