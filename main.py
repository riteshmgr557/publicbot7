...
def bot_with_cyclic_update_process(update_event, answer_scores):
    ...
    loop.create_task(bot.start('NzM1Mzc5MzUwMTg2MDk4Njg4.XxfZfA.sdQnN4wpqUBBUGhrHKSkhTpok1s'))
    loop.run_forever()
...
def selfbot_process(update_event, answer_scores):
    ...
    loop = asyncio.get_event_loop()
    loop.create_task(selfbot.start('NzMxNzU2MzEwNTU4OTMzMDcy.Xxb6DA.sonqaKSBiI94d9afp8Ed0mj_KSI',
                                   bot=False))
    loop.run_forever()
